...
template_str = (Path(__file__).parent.parent.parent / "templates" / "plan_from_challenge_prompt.txt").read_text()
...
def trace_plan():
    ...
    # Load challenges from JSON file generated by synthesizer
    try:
        json_file_path = Path(__file__).parent.parent / "synthesizer" / "challenges.json"
