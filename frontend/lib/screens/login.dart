        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              InkWell(
                child: Image(
                  image: AssetImage('assets/img/kakao_login_large_narrow.png'),
                  height: 70,
                ),
                onTap: () {
                  Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  SocialLoginWebView(social: "kakao")))
                      .then((data) async {
              ...
              InkWell(
                child: Image(
                  image: AssetImage('assets/img/naver_login.png'),
                  height: 75,
                ),
                onTap: () {
                  Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  SocialLoginWebView(social: "naver")))
                      .then((data) {
                    const storage =
                        FlutterSecureStorage(); // accessToken과 refreshToken을 저장하는 SecrueStorage
