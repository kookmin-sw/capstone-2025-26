...
var namedRoute = {
  ...
  Routes.myPage: (context) => const MyPage(),
  Routes.notificationList: (context) => const NotificationListPage(),
  Routes.addPost: (context) => AddPost(),
  Routes.crewAdmin: (context) => const CrewAdminPage(),
  Routes.retrospectDetail: (context) => const RetrospectDetail(),
  Routes.addTemplate: (context) => const AddTemplate(),
};
